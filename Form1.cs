...
namespace SendSMS
{
    ...
    public class Form1 : System.Windows.Forms.Form
    {
        ...
        public const string UserName = "New_city"; //mobile no
        public const string Password = "NCI@123";
        //========================================== //password
        //===================================================
        /// <summary>
        ...
        {
            string str = "Hi There, this is a Sample SMS text sent via C# application";
        ...
        public string SendMessage(string username, string password, string msg, string sender, string numbers)
        {
            ...
            WebRequest.Create("https://bulksms2.etisalat.lk/quick.php");
            req.Method = "POST";
        ...
        private void ShowResult(string res)
        {
            switch (res)
            {
                case "1": MessageBox.Show("case 1"); break;
                case "2": MessageBox.Show("case 2"); break;
                case "3": MessageBox.Show("case 3"); break;
                case "4": MessageBox.Show("case 4"); break;
                case "5": MessageBox.Show("case 5"); break;
                case "6": MessageBox.Show("case 6"); break;
                case "13": MessageBox.Show("case 13"); break;
                case "15": MessageBox.Show("case 15 "); break;
                case "16": MessageBox.Show("case 16"); break;
                case "17": MessageBox.Show("case 17"); break;
